...
{
    List<string> Countries = new List<string>() {"Your Country","Afghanistan","Albania","Algeria","American Samoa","Andorra","Angola","Anguilla","Antarctica","Antigua and Barbuda","Argentina","Armenia",
...
"Western Sahara","Yemen","Zambia","Zimbabwe"};
    ...
    public Dropdown ddCountry;
    public void Country_Changed(int index)
    {
        selectedCountry.text = Countries[index];
    }
    void Start()
    {
        PopulateList();
    ...
    void PopulateList()
    {
        ddCountry.AddOptions(Countries);
    }
}
